...
void CasingBackend::finishSetup(QJsonObject loadJson)
{
    ...
    connect(m_idea.get(), &Idea::inPortLabelColorsChanged,
            this, &CasingBackend::onInPortLabelColorsChanged);
    connect(m_idea.get(), &Idea::outPortLabelColorsChanged,
            this, &CasingBackend::onOutPortLabelColorsChanged);
...
void CasingBackend::onInPortLabelColorsChanged(QList<QColor> inPortLabelColors)
{
    m_casing->setInPortLabelsColor(inPortLabelColors);
}

void CasingBackend::onOutPortLabelColorsChanged(QList<QColor> outPortLabelColors)
{
    m_casing->setOutPortLabelsColor(outPortLabelColors);
}
