...
void Casing::setupInPlugs()
{
    ...
    {
        m_inPlugColors.push_back(m_corkboard->dataTypeRegistry()->dataTypeColor(attributes.dataTypesIn()[i]));
        ...
        QFont labelFont("inconsolata",11);
...
void Casing::setupOutPlugs()
{
    ...
    {
        m_outPlugColors.push_back(m_corkboard->dataTypeRegistry()->dataTypeColor(attributes.dataTypesOut()[i]));
...
void Casing::setupValidationBox()
{
    ...
    QFont statusFont("inconsolata",14);
    ...
    if(event->buttons() == Qt::RightButton)
    {
        ...
        else
        {
            ...
            if(plugIndex2 != -1)
            {
                ...
                PlugNumber inputToWirePlugNum = wires.begin()->second->getPlugIndex(PlugType::DataOut);
