...
public slots: // data propagation
    ...
    void onInPortLabelColorsChanged(QList<QColor> inPortLabelColors);
    void onOutPortLabelColorsChanged(QList<QColor> outPortLabelColors);
...
private:
    ...
    std::vector<QQuickItem*> m_stopLights;
